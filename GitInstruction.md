...
Git многофункциональная программа позволяющая остлеживать версиоонать файлов их историю редактирования и одновременную отработку одного и того же файла разными людьми
